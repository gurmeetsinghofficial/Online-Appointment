...
public class disImg extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	 {
		...
		PreparedStatement ps=con.prepareStatement("select * from `userinfo` where `username`='"+uname+"';"); 
...
//		      ImageIO.write(img, "PNG", f);
		      RequestDispatcher rd=req.getRequestDispatcher("Image.jsp");
		      rd.include(req, res);
