	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	 {
	  try {
		  ...
		  else
		  {
			  ...
			  str="INSERT INTO `Docuserinfo` (`username`, `name`, `gender`, `age`, `occupation`, `salary`, `password`,`image`) VALUES ('"+uname+"', '"+name+"', '"+gender+"', '"+age+"', '"+occ+"', '"+sal+"', '"+pass+ "','" +is+"');";
		
			  String str1="INSERT INTO `Doclogininfo` (`username`, `password`) VALUES ('"+uname+"', '"+pass+"');";
